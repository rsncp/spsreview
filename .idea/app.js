...
var formdisplayRouter=require('./routes/formdisplay');
var formeditRouter=require('./routes/formedit');

var app = express();``
// mongoose.connect('mongodb://localhost:27017/admin',{useUnifiedTopology:true,useNewUrlParser:true});

MongoClient.connect('mongodb://localhost',{useUnifiedTopology:true,useNewUrlParser:true}, (err,client) =>{
    if(err){
      throw err;
    }
...
db.connect(function (error) {
  if(error){
    ...
    console.log('spsreview  Database connected successfully........');
  }
